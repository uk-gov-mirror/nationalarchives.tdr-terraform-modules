CREATE EXTERNAL TABLE IF NOT EXISTS keycloak_new_alb_logs(type string,
    time string,
    elb string,
    client_ip string,
    client_port int,
...
LOCATION
  's3://tdr-alb-logs-${environment}/tdr-keycloak-new-${environment}/AWSLogs/${account_id}/elasticloadbalancing/eu-west-2'
TBLPROPERTIES (
