locals {
  ...
  consignment_export_cluster_arn = var.consignment_export == true ? aws_ecs_cluster.consignment_export_cluster.*.arn[0] : ""
  consignment_export_task_arn    = var.consignment_export == true ? aws_ecs_task_definition.consignment_export_task_definition.*.arn[0] : ""
